...
Cabe mencionar que el AIC del primer modelo fue de `r AICmodelo1` y del modelo final es de `r AICmodelo2`. Por lo que por este criterio también es un mejor modelo. 
