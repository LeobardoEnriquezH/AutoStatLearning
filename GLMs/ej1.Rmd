...
\hline \\[-1.8ex] 
 & \multicolumn{1}{c}{\textit{Dependent variable:}} \\ 
\cline{2-2} 
\\[-1.8ex] & I(bpsystol$\hat{\mkern6mu}$(-1/2)) \\ 
\hline \\[-1.8ex] 
 bmi & $-$0.0004155$^{***}$ \\ 
  & s.e: (6.686e-05) \\ 
  & t value: -6.214 \\ 
...
R$^{2}$ & 0.325 \\ 
Adjusted R$^{2}$ & 0.318 \\ 
Residual Std. Error & 0.006 (df = 291) \\ 
F Statistic & 46.691$^{***}$ (df = 3; 291); p-value: < 2.2e-16 \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{1}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
